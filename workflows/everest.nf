...
/* WorkflowEverest.initialise(params, log) */
...
workflow EVEREST {
    ...
    CLEANING_CONTIGS( DENOVO_WF.out.repseq_fasta )
...
/*
    ...
    // MODULE: MultiQC
    //
    workflow_summary    = WorkflowEverest.paramsSummaryMultiqc(workflow, summary_params)
    ch_workflow_summary = Channel.value(workflow_summary)

    methods_description    = WorkflowEverest.methodsDescriptionText(workflow, ch_multiqc_custom_methods_description)
